...
export const ProductExtraOptionMetaFields = (props) => {
  ...
  const getMetaFields = async () => {
    try {
      ...
      const response = await fetch(`${ordering.root}/business/${businessId}/extras/${extraId}/options/${optionId}/metafields`, requestOptions)
  ...
  const handleDeleteMetaField = async (metaFieldId) => {
    try {
      ...
      const response = await fetch(`${ordering.root}/business/${businessId}/extras/${extraId}/options/${optionId}/metafields/${metaFieldId}`, requestOptions)
      if (response.ok) {
