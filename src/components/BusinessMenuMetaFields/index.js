...
export const BusinessMenuMetaFields = (props) => {
  const {
    businessId,
    menuId,
    metafields,
  ...
  const getMetaFields = async () => {
    try {
      ...
      const response = await fetch(`${ordering.root}/business/${businessId}/menus/${menuId}/metafields`, requestOptions)
  ...
  const handleDeleteMetaField = async (metaFieldId) => {
    try {
      ...
      const response = await fetch(`${ordering.root}/business/${businessId}/menus/${menuId}/metafields/${metaFieldId}`, requestOptions)
      if (response.ok) {
