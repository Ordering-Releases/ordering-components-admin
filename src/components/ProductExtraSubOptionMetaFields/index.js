...
export const ProductExtraSubOptionMetaFields = (props) => {
  ...
  const getMetaFields = async () => {
    try {
      ...
      const response = await fetch(`${ordering.root}/business/${businessId}/extras/${extraId}/options/${optionId}/suboptions/${subOptionId}/metafields`, requestOptions)
  ...
  const handleDeleteMetaField = async (metaFieldId) => {
    try {
      ...
      const response = await fetch(`${ordering.root}/business/${businessId}/extras/${extraId}/options/${optionId}/suboptions/${subOptionId}/metafields/${metaFieldId}`, requestOptions)
      if (response.ok) {
