...
var ProductTagDetails = function ProductTagDetails(props) {
  ...
  var _useState = (0, _react.useState)({
      tag: (_props$tag = props.tag) !== null && _props$tag !== void 0 ? _props$tag : null
    }),
   ...
   */
  var handleUpdateProductTag = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return fetch("".concat(ordering.root, "/tags/").concat(tagState.tag.id), requestOptions);
            case 6:
            ...
            case 9:
              ...
              if (!content.error) {
                setTagState({
                  tag: _objectSpread(_objectSpread({}, tagState.tag), content.result)
                });
                setFormState({
                  loading: false,
                  changes: {},
                ...
                showToast(_ToastContext.ToastType.Success, t('PRODUCT_TAG_SAVED', 'Product tag saved'));
              } else {
                setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                  loading: false,
    ...
    return function handleUpdateProductTag() {
   ...
   */
  var handleAddProductTag = /*#__PURE__*/function () {
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              if (!content.error) {
                ...
                showToast(_ToastContext.ToastType.Success, t('PRODUCT_TAG_ADDED', 'Product tag added'));
    ...
    return function handleAddProductTag() {
   ...
   */
  var handleDeleteProductTag = /*#__PURE__*/function () {
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 9:
              ...
              if (!content.error) {
                ...
                showToast(_ToastContext.ToastType.Success, t('PRODUCT_TAG_DELETED', 'Product tag deleted'));
                props.onClose && props.onClose();
              } else {
                setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                  loading: false,
    ...
    return function handleDeleteProductTag() {
  ...
  (0, _react.useEffect)(function () {
    ...
    setTagState({
      tag: (_props$tag2 = props.tag) !== null && _props$tag2 !== void 0 ? _props$tag2 : null
    });
  }, [props.tag]);
