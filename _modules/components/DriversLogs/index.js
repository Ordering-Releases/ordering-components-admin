...
var DriversLogs = function DriversLogs(props) {
  ...
  var getDriversLogs = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return fetch("".concat(ordering.root, "/users/").concat(userId, "/logs?orderBy=-id&page=").concat(page, "&page_size=").concat(pageSize), requestOptions);
          case 5:
    ...
    return function getDriversLogs(_x2, _x3) {
