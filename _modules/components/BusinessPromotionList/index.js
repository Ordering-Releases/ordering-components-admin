...
var BusinessPromotionList = function BusinessPromotionList(props) {
   ...
   */
  var getBusinessesPromotions = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return fetch("".concat(ordering.root, "/business/").concat(businessId, "/offers"), requestOptions);
          case 5:
    ...
    return function getBusinessesPromotions() {
   ...
   */
  var handleChangePromotionActiveState = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(enabled, promotionId) {
    ...
    return function handleChangePromotionActiveState(_x2, _x3) {
  ...
  var handleDeletePromotion = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(promotionId) {
      var requestOptions, response, content, _promotions;
    ...
    return function handleDeletePromotion(_x4) {
