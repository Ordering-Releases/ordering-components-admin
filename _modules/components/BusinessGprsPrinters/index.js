...
var BusinessGprsPrinters = function BusinessGprsPrinters(props) {
  ...
  var _useState = (0, _react.useState)({
    ...
    printersListState = _useState2[0],
    setPrintersListState = _useState2[1];

  /**
   * Method to get printer list
   */
  var getPrinters = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            _context.prev = 2;
            setPrintersListState(_objectSpread(_objectSpread({}, printersListState), {}, {
              loading: true
            }));
            requestOptions = {
              method: 'GET',
            ...
            functionFetch = "".concat(ordering.root, "/printers");
            _context.next = 8;
