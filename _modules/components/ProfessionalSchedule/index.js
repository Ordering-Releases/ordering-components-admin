  ...
  */
  var handleUpdateClick = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(changes) {
      var _session$user, content, response, _changes2, key, requestOptions, _response, _content, result, error;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return ordering.users(user === null || user === void 0 ? void 0 : user.id).save(formState.changes);
            case 8:
              ...
              break;
            case 12:
              _changes2 = _objectSpread({}, formState.changes);
              for (key in _changes2) {
                if (_typeof(_changes2[key]) === 'object' && _changes2[key] !== null || Array.isArray(_changes2[key])) {
                  _changes2[key] = JSON.stringify(_changes2[key]);
                }
              }
              requestOptions = {
                method: 'POST',
                ...
                body: JSON.stringify(_changes2)
              };
              _context.next = 17;
              return fetch("".concat(ordering.root, "/professionals/").concat(user === null || user === void 0 ? void 0 : user.id), requestOptions);
            case 17:
            ...
            case 21:
              _content = content, result = _content.result, error = _content.error;
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
