...
var AddressFieldsSetting = function AddressFieldsSetting(props) {
  ...
  var _useState = (0, _react.useState)({
    ...
    validationFieldState = _useState2[0],
    setValidationFieldState = _useState2[1];
   ...
   */
  var getAddressFieldsBySite = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var requestOptions, response, _yield$response$json, result, error, filteredResult;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            setValidationFieldState(_objectSpread(_objectSpread({}, validationFieldState), {}, {
              loading: true
            }));
            requestOptions = {
              method: 'GET',
            ...
            if (!error) {
              ...
              if (code === 'address') {
                filteredResult = result.filter(function (field) {
                  var _field$validation_fie, _field$validation_fie2, _field$validation_fie3, _field$validation_fie4, _field$validation_fie5, _field$validation_fie6, _field$validation_fie7, _field$validation_fie8;
                  return (field === null || field === void 0 ? void 0 : (_field$validation_fie = field.validation_field) === null || _field$validation_fie === void 0 ? void 0 : _field$validation_fie.validate) === 'address' && (field === null || field === void 0 ? void 0 : (_field$validation_fie2 = field.validation_field) === null || _field$validation_fie2 === void 0 ? void 0 : _field$validation_fie2.code) !== 'city_dropdown_option' && (field === null || field === void 0 ? void 0 : (_field$validation_fie3 = field.validation_field) === null || _field$validation_fie3 === void 0 ? void 0 : _field$validation_fie3.code) !== 'name' && (field === null || field === void 0 ? void 0 : (_field$validation_fie4 = field.validation_field) === null || _field$validation_fie4 === void 0 ? void 0 : _field$validation_fie4.code) !== 'lastname' && (field === null || field === void 0 ? void 0 : (_field$validation_fie5 = field.validation_field) === null || _field$validation_fie5 === void 0 ? void 0 : _field$validation_fie5.code) !== 'mobile_phone' && (field === null || field === void 0 ? void 0 : (_field$validation_fie6 = field.validation_field) === null || _field$validation_fie6 === void 0 ? void 0 : _field$validation_fie6.code) !== 'email' && (field === null || field === void 0 ? void 0 : (_field$validation_fie7 = field.validation_field) === null || _field$validation_fie7 === void 0 ? void 0 : _field$validation_fie7.code) !== 'middle_name' && (field === null || field === void 0 ? void 0 : (_field$validation_fie8 = field.validation_field) === null || _field$validation_fie8 === void 0 ? void 0 : _field$validation_fie8.code) !== 'second_lastname';
                });
              } else {
                filteredResult = result.filter(function (field) {
                  var _field$validation_fie9;
                  return (field === null || field === void 0 ? void 0 : (_field$validation_fie9 = field.validation_field) === null || _field$validation_fie9 === void 0 ? void 0 : _field$validation_fie9.validate) === 'card';
                });
              }
              setValidationFieldState({
    ...
    return function getAddressFieldsBySite() {
  ...
  var handleChangeFieldSetting = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(fieldId, siteId, changes) {
      var content, fields;
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            if (!content.error) {
              ...
              fields = validationFieldState.fields.map(function (field) {
    ...
    return function handleChangeFieldSetting(_x2, _x3, _x4) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            conditons = [{
              attribute: 'validate',
              value: code !== null && code !== void 0 ? code : 'address'
            }];
            _context3.next = 5;
            return ordering.validationFields().where(conditons).get();
          case 5:
            _yield$ordering$valid = _context3.sent;
  ...
  var updateCheckoutField = /*#__PURE__*/function () {
    ...
    return function updateCheckoutField(_x5, _x6, _x7, _x8) {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            setValidationFieldState(_objectSpread(_objectSpread({}, validationFieldState), {}, {
              fields: [].concat(_toConsumableArray(validationFieldState.fields), _toConsumableArray(content))
            }));
            setActionState(_objectSpread(_objectSpread({}, actionState), {}, {
              loading: false,
              isPost: false
  ...
  (0, _react.useEffect)(function () {
    if (selectedSiteId) {
      var fieldsBySite = validationFieldState === null || validationFieldState === void 0 ? void 0 : validationFieldState.fields.filter(function (field) {
