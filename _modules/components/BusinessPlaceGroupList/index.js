...
exports.BusinessPlaceGroupList = void 0;
...
var BusinessPlaceGroupList = function BusinessPlaceGroupList(props) {
  ...
  var _useState = (0, _react.useState)({
    ...
    placeGroupList = _useState2[0],
    setPlaceGroupList = _useState2[1];
   ...
   */
  var handleSuccessAddPlaceGroup = function handleSuccessAddPlaceGroup(result) {
    var placeGroups = [].concat(_toConsumableArray(placeGroupList.placeGroups), [result]);
   ...
   */
  var handleSuccessUpdatePlaceGroup = /*#__PURE__*/function () {
    ...
    return function handleSuccessUpdatePlaceGroup(_x2) {
  ...
  var getPlaceGroupList = /*#__PURE__*/function () {
    ...
    return function getPlaceGroupList() {
  ...
  var handleChangeEnabled = /*#__PURE__*/function () {
    ...
    return function handleChangeEnabled(_x3, _x4, _x5) {
      return _ref3.apply(this, arguments);
    };
  }();
  var getMultiCheckStatus = function getMultiCheckStatus() {
    var isChecked = true;
    placeGroupList.placeGroups.forEach(function (placeGroup) {
          ...
          case 0:
            ...
            placeGroupList.placeGroups.forEach(function (placeGroup) {
              allPromise.push(new Promise(function (resolve, reject) {
                resolve(handleChangeEnabled(placeGroup.id, {
                  enabled: !isChecked
                }, true));
              }));
            });
