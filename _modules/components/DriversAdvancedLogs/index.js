...
var DriversAdvancedLogs = function DriversAdvancedLogs(props) {
  ...
  var getDriversAdvancedLogs = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageSize) {
      var requestOptions, conditions, query, queryString, response, _yield$response$json, error, pagination, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            queryString = '';
            Object.keys(query).map(function (param) {
              queryString = queryString + "".concat(param, "=").concat(query[param], "&");
            });
            _context.next = 9;
            return fetch("".concat(ordering.root, "/tracking_events?").concat(queryString, "&where=").concat(JSON.stringify(conditions)), requestOptions);
          case 9:
