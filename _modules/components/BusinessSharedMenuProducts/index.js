...
var BusinessSharedMenuProducts = function BusinessSharedMenuProducts(props) {
  ...
  var handleUpdateBusinessSharedMenuProduct = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(productId, changes) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            if (!content.error) {
              menusShared = menuList === null || menuList === void 0 ? void 0 : (_menuList$menusShared = menuList.menusShared) === null || _menuList$menusShared === void 0 ? void 0 : _menuList$menusShared.map(function (sharedMenu) {
                ...
                return _objectSpread(_objectSpread({}, sharedMenu), {}, {
                  products: products
                });
              });
              ...
              setMenuState(_objectSpread(_objectSpread({}, menuState), {}, {
                menu: menusShared.find(function (_menu) {
                  return (_menu === null || _menu === void 0 ? void 0 : _menu.id) === (menu === null || menu === void 0 ? void 0 : menu.id);
                })
              }));
            } else {
              setActionState({
    ...
    return function handleUpdateBusinessSharedMenuProduct(_x2, _x3) {
