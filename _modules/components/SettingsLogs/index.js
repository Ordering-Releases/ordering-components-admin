...
var SettingsLogs = function SettingsLogs(props) {
   ...
   */
  var getSettingsLogs = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageSize) {
      var _res$pagination, _res$pagination2, _res$pagination3, _res$pagination4, _res$pagination5, response, res, _error$message;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return fetch("".concat(ordering.root, "/configs/logs?orderBy=-id&page=").concat(page, "&page_size=").concat(pageSize), {
              method: 'GET',
              headers: {
    ...
    return function getSettingsLogs(_x2, _x3) {
...
SettingsLogs.propTypes = {
   ...
   */
  paginationSettings: _propTypes.default.shape({
