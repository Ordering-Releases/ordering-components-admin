...
exports.BusinessMetaFields = void 0;
...
var BusinessMetaFields = function BusinessMetaFields(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return fetch("".concat(ordering.root, "/business/").concat(businessId, "/metafields"), requestOptions);
          case 5:
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return fetch("".concat(ordering.root, "/business/").concat(businessId, "/metafields/").concat(metaFieldId), requestOptions);
          case 5:
...
exports.BusinessMetaFields = BusinessMetaFields;
BusinessMetaFields.propTypes = {
  /**
...
BusinessMetaFields.defaultProps = {
  beforeComponents: [],
  afterComponents: [],
  beforeElements: [],
  afterElements: []
