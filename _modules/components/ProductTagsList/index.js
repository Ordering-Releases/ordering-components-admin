...
var ProductTagsList = function ProductTagsList(props) {
  var tags = props.tags,
    ...
    handleSuccessProductUpdate = props.handleSuccessProductUpdate;
  ...
  var _useState = (0, _react.useState)({
    ...
    setTagsState = _useState2[1];
  var _useState3 = (0, _react.useState)([]),
    _useState4 = _slicedToArray(_useState3, 2),
    selectedTagIds = _useState4[0],
    setSelectedTagIds = _useState4[1];
   ...
   */
  var getProductTags = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var requestOptions, where, conditions, fetchEndpoint, response, content;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            setTagsState(_objectSpread(_objectSpread({}, tagsState), {}, {
              loading: true
            }));
            requestOptions = {
              method: 'GET',
            ...
            fetchEndpoint = where ? "".concat(ordering.root, "/tags?where=").concat(JSON.stringify(where)) : "".concat(ordering.root, "/tags");
            _context.next = 10;
    ...
    return function getProductTags() {
   ...
   */
  var handleUpdateProductTags = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tagIds) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return ordering.businesses(businessId).categories(product.category_id).products(product.id).save(changes, {
              accessToken: token
            });
          case 6:
    ...
    return function handleUpdateProductTags(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();
  var handleSuccessUpdate = function handleSuccessUpdate(updatedTag) {
    var tags = tagsState.tags.map(function (tag) {
      if (tag.id === updatedTag.id) {
        return _objectSpread(_objectSpread({}, tag), updatedTag);
      }
      return tag;
    });
    setTagsState(_objectSpread(_objectSpread({}, tagsState), {}, {
  ...
  var handleSuccessDelete = function handleSuccessDelete(tagId) {
    var tags = tagsState.tags.filter(function (tag) {
      return tag.id !== tagId;
    });
    setTagsState(_objectSpread(_objectSpread({}, tagsState), {}, {
      tags: tags
  ...
  var handleSuccessAdd = function handleSuccessAdd(tag) {
    setTagsState(_objectSpread(_objectSpread({}, tagsState), {}, {
      tags: [].concat(_toConsumableArray(tagsState.tags), [tag])
    }));
  };
   ...
   */
  var handleChangeProductTag = function handleChangeProductTag(checked, tagId) {
    var tagIds = [];
    if (checked) {
      tagIds = [].concat(_toConsumableArray(selectedTagIds), [tagId]);
    } else {
      tagIds = selectedTagIds.filter(function (id) {
  ...
  var handleSelectNoneTags = function handleSelectNoneTags() {
    setSelectedTagIds([]);
