...
var ProductStep = function ProductStep(props) {
  ...
  var _useState5 = (0, _react.useState)({
    ...
    businessListState = _useState6[0],
    setBusinessListState = _useState6[1];
  ...
  var handleChangeAddress = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ad) {
      var _ad$location, _ad$location2, requestOptions, lat, lng, url, response, _yield$response$json, error, result, sortedBusinessList;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            setBusinessListState(_objectSpread(_objectSpread({}, businessListState), {}, {
              loading: true
            }));
            requestOptions = {
              method: 'GET',
