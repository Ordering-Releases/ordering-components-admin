...
var BusinessDeviceListing = function BusinessDeviceListing(props) {
  ...
  var _useState3 = (0, _react.useState)({
    ...
    deviceListState = _useState4[0],
    setDeviceListState = _useState4[1];

  /**
   * Method to update device list
   */
  var handleUpdateDeviceList = function handleUpdateDeviceList(devices) {
    setDeviceListState(_objectSpread(_objectSpread({}, deviceListState), {}, {
      devices: devices
    }));
  };
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            functionFetch = "".concat(ordering.root, "/devices");
            _context.next = 8;
