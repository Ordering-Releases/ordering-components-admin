...
var DriverAnalytics = function DriverAnalytics(props) {
  ...
  var paramsForAPI = function paramsForAPI(type) {
    ...
    if (filterList !== null && filterList !== void 0 && filterList.userIds) params = "".concat(params, "&drivers=").concat(filterList === null || filterList === void 0 || (_filterList$userIds = filterList.userIds) === null || _filterList$userIds === void 0 ? void 0 : _filterList$userIds.toString());
