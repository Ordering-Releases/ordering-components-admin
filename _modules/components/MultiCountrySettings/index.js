...
var MultiCountrySettings = function MultiCountrySettings(props) {
  ...
  var _useState = (0, _react.useState)({
    ...
    countryState = _useState2[0],
    setCountryState = _useState2[1];
  var _useState3 = (0, _react.useState)({
    ...
    countryConfigState = _useState4[0],
    setCountryConfigState = _useState4[1];
   ...
   */
  var handleGetCountryList = /*#__PURE__*/function () {
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (!error) {
              ...
              setCountryState(_objectSpread(_objectSpread({}, countryState), {}, {
                loading: false,
                error: result
              }));
            }
    ...
    return function handleGetCountryList() {
   ...
   */
  var handleGetContryConfigs = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(countryId) {
      var requestOptions, response, _yield$response$json2, error, result;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            setCountryConfigState(_objectSpread(_objectSpread({}, countryConfigState), {}, {
              loading: true
            }));
            requestOptions = {
              method: 'GET',
            ...
            _context2.next = 5;
            return fetch("".concat(ordering.root, "/countries/").concat(countryId, "/configs"), requestOptions);
          case 5:
    ...
    return function handleGetContryConfigs(_x2) {
  ...
  var handleChangeConfig = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(value, countryId, configId) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return fetch("".concat(ordering.root, "/countries/").concat(countryId, "/configs/").concat(configId), requestOptions);
          case 6:
    ...
    return function handleChangeConfig(_x3, _x4, _x5) {
