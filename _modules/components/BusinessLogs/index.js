...
var BusinessLogs = function BusinessLogs(props) {
  ...
  var getBusinesssLogs = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageSize) {
      var _content$pagination, _content$pagination2, _content$pagination3, _content$pagination4, _content$pagination5, requestOptions, response, content, _error$message;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return fetch("".concat(ordering.root, "/business/").concat(businessId, "/logs?orderBy=-id&page=").concat(page, "&page_size=").concat(pageSize), requestOptions);
          case 5:
          ...
          case 13:
            ...
            setLogsList(_objectSpread(_objectSpread({}, logsList), {}, {
              loading: false,
              error: (_error$message = _context.t0 === null || _context.t0 === void 0 ? void 0 : _context.t0.message) !== null && _error$message !== void 0 ? _error$message : _context.t0
            }));
          case 16:
          case "end":
    ...
    return function getBusinesssLogs(_x2, _x3) {
