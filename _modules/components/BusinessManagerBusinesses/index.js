...
var BusinessManagerBusinesses = function BusinessManagerBusinesses(props) {
  ...
  var _useState3 = (0, _react.useState)([]),
      ...
      selectedBusinessIds = _useState4[0],
      setSelectedBusinessIds = _useState4[1];
  ...
  var getDefaultBusinesses = /*#__PURE__*/function () {
    ...
    return function getDefaultBusinesses() {
  ...
  var handleUpdateBusinesses = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return ordering.setAccessToken(token).users(userId).save({
    ...
    return function handleUpdateBusinesses() {
