...
var LanguageTransSpread = function LanguageTransSpread(props) {
  ...
  var createBulkTranslations = /*#__PURE__*/function () {
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            if (!error) {
              ...
              showToast(_ToastContext.ToastType.Success, isPost ? t('WEB_APP_LANG_ADDED', 'Language item added') : t('WEB_APP_LANG_SAVED', 'Language change saved'));
            } else {
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                loading: false,
                result: {
    ...
    return function createBulkTranslations(_x2, _x3, _x4) {
