...
var CustomDomain = function CustomDomain(props) {
  ...
  var handleSaveConfig = /*#__PURE__*/function () {
    ...
    return function handleSaveConfig(_x2) {
      return _ref.apply(this, arguments);
    };
  }();
  var handleSaveDomain = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return fetch("".concat(ordering.root, "/sites/").concat(site === null || site === void 0 ? void 0 : site.id), requestOptions);
          case 3:
    ...
    return function handleSaveDomain(_x3) {
  ...
  */
  var handleChangeCustomDomain = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(mapKey) {
      var _configs$google_maps_2, mapApiKeyChanges, requestOptions, response, _yield$response$json2, error, result, _formState$changes;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return handleSaveConfig(mapApiKeyChanges);
          case 6:
            _context3.next = 8;
            return handleSaveDomain(formState === null || formState === void 0 ? void 0 : formState.changes);
          case 8:
            requestOptions = {
              method: 'POST',
              headers: {
            ...
            _context3.next = 11;
            return fetch("".concat(ordering.root, "/sites/").concat(site === null || site === void 0 ? void 0 : site.id, "/ssl/re-issue"), requestOptions);
          case 11:
    ...
    return function handleChangeCustomDomain(_x4) {
