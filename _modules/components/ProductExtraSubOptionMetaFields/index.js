...
var ProductExtraSubOptionMetaFields = function ProductExtraSubOptionMetaFields(props) {
  var businessId = props.businessId,
    ...
    handleSuccessAddMetaFields = props.handleSuccessAddMetaFields,
    handleSuccessDeleteBusinessMetaFields = props.handleSuccessDeleteBusinessMetaFields;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return fetch("".concat(ordering.root, "/business/").concat(businessId, "/extras/").concat(extraId, "/options/").concat(optionId, "/suboptions/").concat(subOptionId, "/metafields"), requestOptions);
            case 5:
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return fetch("".concat(ordering.root, "/business/").concat(businessId, "/extras/").concat(extraId, "/options/").concat(optionId, "/suboptions/").concat(subOptionId, "/metafields/").concat(metaFieldId), requestOptions);
            case 6:
...
ProductExtraSubOptionMetaFields.propTypes = {
  /**
  ...
  /**
   * Components types before product extra suboption metafields
   * Array of type components, the parent props will pass to these components
   */
  beforeComponents: _propTypes.default.arrayOf(_propTypes.default.elementType),
  /**
   * Components types after product extra suboption metafields
   * Array of type components, the parent props will pass to these components
   */
  afterComponents: _propTypes.default.arrayOf(_propTypes.default.elementType),
  /**
   * Elements before product extra suboption metafields
   * Array of HTML/Components elements, these components will not get the parent props
   */
  beforeElements: _propTypes.default.arrayOf(_propTypes.default.element),
  /**
   * Elements after product extra suboption metafields
   * Array of HTML/Components elements, these components will not get the parent props
   */
  afterElements: _propTypes.default.arrayOf(_propTypes.default.element)
};
ProductExtraSubOptionMetaFields.defaultProps = {
  beforeComponents: [],
  afterComponents: [],
  beforeElements: [],
  afterElements: []
