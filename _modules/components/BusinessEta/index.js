...
var BusinessEta = function BusinessEta(props) {
  ...
  var _useState3 = (0, _react.useState)({
      loading: false,
      changes: (business === null || business === void 0 ? void 0 : business.eta_status_times) || {},
      error: null
    }),
  ...
  var handleChangeInput = function handleChangeInput(e) {
    setFormState(_objectSpread(_objectSpread({}, formState), {}, {
      changes: _objectSpread(_objectSpread({}, formState.changes), {}, _defineProperty({}, e.target.name, Number(e.target.value)))
    }));
  };
  var hanldeUpdateBusinessEtaTimes = /*#__PURE__*/function () {
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            requestOptions = {
              ...
              body: JSON.stringify({
                eta_status_times: JSON.stringify(formState.changes)
              })
            };
            _context.next = 6;
          ...
          case 9:
            ...
            if (!content.error) {
              ...
              _business = _objectSpread(_objectSpread({}, business), {}, {
                eta_status_times: formState.changes
              });
              handleUpdateBusinessState(_business);
              showToast(_ToastContext.ToastType.Success, t('SAVED', 'Saved'));
            } else {
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                loading: false,
    ...
    return function hanldeUpdateBusinessEtaTimes() {
