...
var OccupationSelector = function OccupationSelector(props) {
  ...
  var _useEvent = (0, _EventContext.useEvent)(),
    ...
    events = _useEvent2[0];
  var _useState = (0, _react.useState)(props.occupationId),
    _useState2 = _slicedToArray(_useState, 2),
    occupationId = _useState2[0],
    setOccupationId = _useState2[1];
  var _useState3 = (0, _react.useState)(props.occupations),
    _useState4 = _slicedToArray(_useState3, 2),
    occupations = _useState4[0],
    setOccupations = _useState4[1];
  ...
  var handleAddOccupation = /*#__PURE__*/function () {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            if (!content.error) {
              ...
              setOccupations([].concat(_toConsumableArray(occupations), [content.result]));
              setOccupationId(content.result.id);
              handleChangeOccupation(content.result.id);
              events.emit('occupations_update', [].concat(_toConsumableArray(occupations), [content.result]));
            } else {
              setActionState({
                loading: false,
                error: content.result
    ...
    return function handleAddOccupation(_x2) {
