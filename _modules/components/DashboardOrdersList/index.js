...
var DashboardOrdersList = function DashboardOrdersList(props) {
  var _paginationSettings$p, _configState$configs;
  ...
  var filterDefaultOrderDate = configState === null || configState === void 0 || (_configState$configs = configState.configs) === null || _configState$configs === void 0 || (_configState$configs = _configState$configs.filter_default_order_date) === null || _configState$configs === void 0 ? void 0 : _configState$configs.value;
  ...
  var isFilteredOrder = function isFilteredOrder(order, lastHistoryData) {
    ...
    if (searchValue) {
      ...
      if (isSearchByCustomerName) {
        var _order$customer;
        if (((order === null || order === void 0 || (_order$customer = order.customer) === null || _order$customer === void 0 ? void 0 : _order$customer.name) || '').toLowerCase().includes(lowerCaseSearchValue)) searchCheck = true;
      }
      if (isSearchByCustomerEmail) {
        var _order$customer2;
        if (((order === null || order === void 0 || (_order$customer2 = order.customer) === null || _order$customer2 === void 0 ? void 0 : _order$customer2.email) || '').toLowerCase().includes(lowerCaseSearchValue)) searchCheck = true;
      }
      if (isSearchByCustomerPhone) {
        var _order$customer3;
        if (((order === null || order === void 0 || (_order$customer3 = order.customer) === null || _order$customer3 === void 0 ? void 0 : _order$customer3.cellphone) || '').toLowerCase().includes(lowerCaseSearchValue)) searchCheck = true;
      }
      if (isSearchByBusinessName) {
        var _order$business;
    ...
    if (filterValues !== null && filterValues !== void 0 && filterValues.customerName) {
      var _order$customer4;
      if (!(order !== null && order !== void 0 && (_order$customer4 = order.customer) !== null && _order$customer4 !== void 0 && (_order$customer4 = _order$customer4.name) !== null && _order$customer4 !== void 0 && _order$customer4.toString().includes(filterValues === null || filterValues === void 0 ? void 0 : filterValues.customerName))) filterCheck = false;
    }
    if (filterValues !== null && filterValues !== void 0 && filterValues.customerLastname) {
      var _order$customer5;
      if (!(order !== null && order !== void 0 && (_order$customer5 = order.customer) !== null && _order$customer5 !== void 0 && (_order$customer5 = _order$customer5.lastname) !== null && _order$customer5 !== void 0 && _order$customer5.toString().includes(filterValues === null || filterValues === void 0 ? void 0 : filterValues.customerLastname))) filterCheck = false;
    }
    if (filterValues !== null && filterValues !== void 0 && filterValues.customerCellphone) {
      var _order$customer6;
      if (!(order !== null && order !== void 0 && (_order$customer6 = order.customer) !== null && _order$customer6 !== void 0 && (_order$customer6 = _order$customer6.cellphone) !== null && _order$customer6 !== void 0 && _order$customer6.toString().includes(filterValues === null || filterValues === void 0 ? void 0 : filterValues.customerCellphone))) filterCheck = false;
    }
    if (filterValues !== null && filterValues !== void 0 && filterValues.orderId) {
      var _order$id2;
