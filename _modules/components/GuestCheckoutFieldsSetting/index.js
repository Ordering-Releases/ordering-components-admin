...
var GuestCheckoutFieldsSetting = function GuestCheckoutFieldsSetting(props) {
  ...
  var handleChangeCheckoutFieldSetting = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(fieldId, orderTypeId, changes) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return fetch("".concat(ordering.root, "/validationfields/").concat(fieldId, "/order_types/").concat(orderTypeId), requestOptions);
          case 6:
    ...
    return function handleChangeCheckoutFieldSetting(_x2, _x3, _x4) {
