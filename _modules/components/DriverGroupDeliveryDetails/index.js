...
var DriverGroupDeliveryDetails = function DriverGroupDeliveryDetails(props) {
  ...
  var _useState3 = (0, _react.useState)({
    ...
    zoneList = _useState4[0],
    setZoneList = _useState4[1];
  ...
  var _useState7 = (0, _react.useState)({
    ...
    zoneListState = _useState8[0],
    setZoneListState = _useState8[1];

  /**
   * Method to get the deliveryzones from the API
   */
  var getDeliveryZones = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var requestOptions, response, content;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            setZoneList(_objectSpread(_objectSpread({}, zoneList), {}, {
              loading: true,
              error: null
            }));
            _context.prev = 1;
    ...
    return function getDeliveryZones() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return fetch("".concat(ordering.root, "/drivergroups/").concat(drivergroup === null || drivergroup === void 0 ? void 0 : drivergroup.id, "/deliveryzones/").concat(zoneId), requestOptions);
          case 4:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 12:
            ...
            showToast(_ToastContext.ToastType.Success, t('DRIVER_GROUP_UPDATED', 'Driver group updated'));
            _context4.next = 19;
            break;
          case 16:
            _context4.prev = 16;
  ...
  (0, _react.useEffect)(function () {
    ...
    var zoneChanges = {};
    zoneListFilter === null || zoneListFilter === void 0 ? void 0 : zoneListFilter.forEach(function (zone) {
      zoneChanges[zone.id] = zone.enabled;
    });
    setZoneListState(_objectSpread(_objectSpread({}, zoneListState), {}, {
      changes: zoneChanges
    }));
  }, [zoneList === null || zoneList === void 0 ? void 0 : zoneList.zones]);
  (0, _react.useEffect)(function () {
    getDeliveryZones();
  }, [drivergroup === null || drivergroup === void 0 ? void 0 : drivergroup.id]);
