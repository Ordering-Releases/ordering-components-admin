        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return fetch("".concat(ordering.root, "/business/").concat(businessId, "/extras/").concat(extraId, "/options/").concat(optionId, "/metafields"), requestOptions);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return fetch("".concat(ordering.root, "/business/").concat(businessId, "/extras/").concat(extraId, "/options/").concat(optionId, "/metafields/").concat(metaFieldId), requestOptions);
...
ProductExtraOptionMetaFields.propTypes = {
  /**
  ...
  /**
   * Components types before product extra option metafields
   * Array of type components, the parent props will pass to these components
   */
  beforeComponents: _propTypes.default.arrayOf(_propTypes.default.elementType),

  /**
   * Components types after product extra option metafields
   * Array of type components, the parent props will pass to these components
   */
  afterComponents: _propTypes.default.arrayOf(_propTypes.default.elementType),

  /**
   * Elements before product extra option metafields
   * Array of HTML/Components elements, these components will not get the parent props
   */
  beforeElements: _propTypes.default.arrayOf(_propTypes.default.element),

  /**
   * Elements after product extra option metafields
   * Array of HTML/Components elements, these components will not get the parent props
   */
  afterElements: _propTypes.default.arrayOf(_propTypes.default.element)
};
ProductExtraOptionMetaFields.defaultProps = {
  beforeComponents: [],
  afterComponents: [],
  beforeElements: [],
  afterElements: []
