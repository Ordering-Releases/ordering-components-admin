...
exports.ReviewProductList = void 0;
...
var ReviewProductList = function ReviewProductList(props) {
  ...
  var _useState3 = (0, _react.useState)({
    ...
    setProductState = _useState4[1];
  var handleChangeSearch = function handleChangeSearch(value) {
    setSearchValue(value);
  };
  var getProducts = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var where, searchConditions, productEndpoint, _yield$productEndpoin, _yield$productEndpoin2, error, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            productEndpoint = where.conditions.length > 0 ? ordering.businesses(businessId).products().where(where) : ordering.businesses(businessId).products();
            _context.next = 9;
          ...
          case 9:
            ...
            if (!error) {
              setProductState(_objectSpread(_objectSpread({}, productState), {}, {
                products: _toConsumableArray(new Map(result.map(function (item) {
                  return [item.id, item];
                })).values()),
                loading: false,
                error: null
...
exports.ReviewProductList = ReviewProductList;
