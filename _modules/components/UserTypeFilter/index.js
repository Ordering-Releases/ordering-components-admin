...
var UserTypeFilter = function UserTypeFilter(props) {
  ...
  var handleChangeUserType = function handleChangeUserType(userTypes) {
...
UserTypeFilter.propTypes = {
   ...
   */
  userTypes: _propTypes.default.arrayOf(_propTypes.default.object),
   ...
   */
  onChangeUserType: _propTypes.default.func,
