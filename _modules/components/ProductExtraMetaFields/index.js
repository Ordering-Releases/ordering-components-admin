        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return fetch("".concat(ordering.root, "/business/").concat(businessId, "/extras/").concat(extraId, "/metafields"), requestOptions);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return fetch("".concat(ordering.root, "/business/").concat(businessId, "/extras/").concat(extraId, "/metafields/").concat(metaFieldId), requestOptions);
