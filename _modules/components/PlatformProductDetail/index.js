...
exports.PlatformProductDetail = void 0;
...
var PlatformProductDetail = function PlatformProductDetail(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            fetchEndpoint = "".concat(ordering.root, "/platform_products/").concat(product === null || product === void 0 ? void 0 : product.id);
            _context.next = 7;
          ...
          case 10:
            ...
            if (!error) {
              showToast(_ToastContext.ToastType.Success, t('GIFT_CARD_DELETED', 'Gift card deleted'));
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                loading: false,
                error: null,
                changes: {}
              }));
              handleSuccessDeleteProduct(product === null || product === void 0 ? void 0 : product.id);
              onClose && onClose();
            } else {
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                loading: false,
  ...
  var handleUpdateProduct = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(payload) {
      var changes, key, _changes, requestOptions, response, _yield$response$json2, error, result;
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (payload) {
              ...
              for (key in changes) {
                if (!((_changes = changes) !== null && _changes !== void 0 && _changes.name) && changes[key] === '') {
                  changes[key] = null;
                }
              }
            }
            ...
            _context2.next = 7;
            return fetch("".concat(ordering.root, "/platform_products/").concat(product === null || product === void 0 ? void 0 : product.id), requestOptions);
          case 7:
          ...
          case 10:
            ...
            if (!error) {
              ...
              showToast(_ToastContext.ToastType.Success, t('GIFT_CARD_UPDATED', 'Gift card updated'));
            } else {
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                loading: false,
                error: result
    ...
    return function handleUpdateProduct(_x2) {
  ...
  var handleAddProduct = /*#__PURE__*/function () {
        ...
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            requestOptions = {
              ...
              body: JSON.stringify(_objectSpread(_objectSpread({}, formState.changes), {}, {
                type: type
              }))
            };
            fetchEndpoint = "".concat(ordering.root, "/platform_products");
            _context3.next = 7;
            return fetch(fetchEndpoint, requestOptions);
          case 7:
          ...
          case 10:
            ...
            if (!error) {
              showToast(_ToastContext.ToastType.Success, t('GIFT_CARD_ADDED', 'Gift card added'));
              setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                loading: false,
                error: null,
                changes: {}
    ...
    return function handleAddProduct(_x3) {
