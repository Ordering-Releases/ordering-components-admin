...
var LanguageTransTable = function LanguageTransTable(props) {
   ...
   */
  var handleChangeInput = function handleChangeInput(type, evt) {
    setFormState(_objectSpread(_objectSpread({}, formState), {}, {
      changes: _objectSpread(_objectSpread({}, formState === null || formState === void 0 ? void 0 : formState.changes), {}, _defineProperty({}, type, evt.target.value))
    }));
  };
   ...
   */
  var createTranslation = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return ordering.translations().save(formState === null || formState === void 0 ? void 0 : formState.changes);
            case 5:
              ...
              if (!error) {
                ...
                showToast(_ToastContext.ToastType.Success, t('WEB_APP_LANG_ADDED', 'Language item added'));
              } else {
                setFormState(_objectSpread(_objectSpread({}, formState), {}, {
                  loading: false,
                  result: {
    ...
    return function createTranslation() {
