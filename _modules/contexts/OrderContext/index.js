...
var OrderProvider = function OrderProvider(_ref) {
  ...
  var removeProduct = /*#__PURE__*/function () {
    ...
    return function removeProduct(_x8) {
  ...
  var updateProduct = /*#__PURE__*/function () {
    ...
    return function updateProduct(_x10) {
  ...
  var applyCoupon = /*#__PURE__*/function () {
    ...
    return function applyCoupon(_x11) {
  ...
  var changeDriverTip = /*#__PURE__*/function () {
    ...
    return function changeDriverTip(_x12, _x13) {
  ...
  (0, _react.useEffect)(function () {
    ...
    socket.join({
      room: 'orders',
      user_id: session === null || session === void 0 ? void 0 : (_session$user5 = session.user) === null || _session$user5 === void 0 ? void 0 : _session$user5.id,
      role: 'manager'
    });
